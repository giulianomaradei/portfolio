    ...
    <div class="container mx-auto px-6">
      ...
      <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
        <div 
          ...
          :key="project.title"
          class="bg-card border border-border rounded-lg overflow-hidden hover:border-primary/50 transition-all duration-300 hover:scale-105 group"
        >
          <div class="relative h-48 bg-gradient-to-br from-primary/20 to-accent/20 flex items-center justify-center">
            <Code2 class="w-16 h-16 text-primary/50 group-hover:text-primary transition-colors" />
            <div class="absolute top-4 right-4 bg-primary/20 text-primary px-2 py-1 rounded text-xs font-mono">
              {{ project.category }}
            </div>
          </div>
...
const projects = [
  ...
  {
    title: 'CultureCore',
    description: 'A custom-built employee recognition platform where team members appreciate peers, earn awards and "bucks", and redeem debit and gift cards. Supports unlimited users with negligible operational costs!',
    myRole: 'Worked on it from the beginning, a complete social network. Worked on third-party service integrations, in-app store, comment systems, posts, and many core system functionalities.',
